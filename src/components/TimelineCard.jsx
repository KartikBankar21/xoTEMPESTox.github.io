        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mt-6 pt-6 flex justify-between items-center">
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${item.type === "edu" ? "bg-zinc-600" : "bg-teal-700"
                  }`}
              ></div>
            ...
            <span
              className={`text-[10px] md:text-xl font-mono uppercase px-4 py-1.5 rounded-md bg-white/5 ${item.type === "edu" ? "text-blue-500" : "text-purple-500"
                }`}
            >
