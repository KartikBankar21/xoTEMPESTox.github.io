  ...
  <div className="relative h-full w-full overflow-hidden" data-theme={theme}>
    ...
    >
      ...
      >
        ...
        >
          <p className={`w-full text-center text-xs lg:text-xl font-bold tracking-wide truncate transition-colors ${
            theme === "dark" ? "text-white opacity-80 group-hover:opacity-100" : "text-black opacity-80 group-hover:opacity-100"
          }`}>
            {currentTrack.title}
          </p>
          <p className={`w-full text-center text-[10px] lg:text-lg truncate transition-colors ${
      ...
      <div className="flex flex-row-reverse items-center justify-center lg:flex lg:flex-col lg:items-center lg:justify-between lg:rotate-180 space-x-2 space-x-reverse lg:space-x-0 lg:space-y-4 flex-shrink-0">
        ...
        <button onClick={onPrev} className="group relative p-2 active:scale-95 transition-all duration-300 flex-shrink-0">
          <div className={`absolute inset-0 rounded-full blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 scale-75 group-hover:scale-110 ${
            theme === "dark" ? "bg-white/10" : "bg-black/5"
          }`} />
          <div className="relative z-10 transition-transform duration-300 group-hover:scale-110">
            <SkipBack className={`w-5 h-5 lg:w-7 lg:h-7 fill-current rotate-180 lg:rotate-90 transition-colors duration-300 ${
              theme === "dark" ? "text-gray-400 group-hover:text-white" : "text-gray-400 group-hover:text-black"
            }`} />
          </div>
        </button>
        ...
        <button onClick={handleAudioPlay} className="group relative p-2 lg:p-3 rounded-full active:scale-95 transition-all duration-300 flex-shrink-0">
          ...
          <div className="relative z-10 transition-transform duration-300 group-hover:scale-110">
            {isPlaying ? (
              <Pause className={`w-6 h-6 lg:w-8 lg:h-8 fill-current transition-colors duration-300 lg:rotate-90 ${
                theme === "dark" ? "text-gray-400 group-hover:text-white" : "text-gray-400 group-hover:text-black"
              }`} />
            ) : (
              <Play className={`w-6 h-6 lg:w-8 lg:h-8 fill-current transition-colors duration-300 lg:rotate-90 ${
                theme === "dark" ? "text-gray-400 group-hover:text-white" : "text-gray-400 group-hover:text-black"
              }`} />
            )}
          </div>
        ...
        <button onClick={onNext} className="group relative p-2 active:scale-95 transition-all duration-300 flex-shrink-0">
          ...
          <div className="relative z-10 transition-transform duration-300 group-hover:scale-110">
            <SkipForward className={`w-5 h-5 lg:w-7 lg:h-7 fill-current rotate-180 lg:rotate-90 transition-colors duration-300 ${
              theme === "dark" ? "text-gray-400 group-hover:text-white" : "text-gray-400 group-hover:text-black"
            }`} />
          </div>
        </button>
