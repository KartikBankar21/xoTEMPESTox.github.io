...
const SvgLoaderNaturalWrite = ({ onFinish }) => {
  // Parent controls the sequence (stagger)
  const svgVariants = {
    hidden: { opacity: 1 },
    visible: {
      opacity: 1,
      transition: {
        staggerChildren: 0.35, // Delay between the start of each stroke
      },
    },
  };

  // Base drawing behavior
  const pathVariants = {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full bg-black">
      ...
      >
        {/* Path 1: Initial 'P' - A long, complex stroke */}
        <motion.path
          id="ew7Dz8ECLWi4"
          ...
          transition={{ duration: 1.8, ease: "easeInOut" }} // Slower for the capital letter
        />

        {/* Path 2 & 3: Quick middle strokes */}
        <motion.path
          id="ew7Dz8ECLWi5"
        ...
        {/* Path 4: A tiny segment/dot - very fast */}
        <motion.path
          id="ew7Dz8ECLWi7"
          ...
          strokeWidth="2"
          variants={pathVariants}
          transition={{ duration: 0.3 }} // "Flick" of the pen
        />

        {/* Path 5, 6, 7: Main name body */}
        <motion.path
          id="ew7Dz8ECLWi8"
        ...
        {/* Path 9: Final flourish - Fast exit */}
        <motion.path
          id="ew7Dz8ECLWi13"
          ...
          onAnimationComplete={onFinish} // Trigger finished when the LAST stroke completes
        />
      </motion.svg>
    </div>
  );
...
export default SvgLoaderNaturalWrite;